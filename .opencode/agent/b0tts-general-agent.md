...
- Read `AGENTS.md` in the working directory first and follow its rules.
- Break multi-step work into a todo list; keep one item in progress at a time.
- Verify changes with the project's build/test/lint commands when they exist.

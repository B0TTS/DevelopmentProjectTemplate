...
**Wave goal:** verify 4 more candidates with the same strict protocol. Run-wide: 7 PASS banked; target ≥12 PASS (prefer 15).
...
1. Thomas Frank — https://www.youtube.com/@Thomasfrank — slug `thomas-frank`
2. Matt D'Avella — https://www.youtube.com/@mattdavella — slug `matt-davella`
3. Colin and Samir — https://www.youtube.com/@ColinandSamir — slug `colin-and-samir`
4. Kurtis Conner — https://www.youtube.com/@kurtisConner — slug `kurtis-conner`
...
**Lead output:** `working/waves/report-04.md` — per-worker status, anomalies, next actions. Lead final message ≤500 words.

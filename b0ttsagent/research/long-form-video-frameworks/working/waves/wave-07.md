...
1. mrbeast — MrBeast — shortlist rank #1
2. mark-rober — Mark Rober — shortlist rank #2
3. airrack — Airrack/Eric Decker — shortlist rank #3
...
**Lead output:** `working/waves/report-07.md` — per-worker status (done / fail / retried), verdicts, anomalies, next actions. Lead final message ≤500 words: status, file paths, verdicts, next actions. Never paste file contents.

...
**Wave goal:** verify 4 more candidates with the same strict protocol. Run-wide: 14 PASS banked; preferred target 15 (cap shortlist at 15).
...
1. Dan Koe — https://www.youtube.com/@DanKoeTalks — slug `dan-koe`
2. Linus Tech Tips (Linus Sebastian) — https://www.youtube.com/@LinusTechTips — slug `linus-tech-tips`
3. Airrack (Eric Decker) — https://www.youtube.com/@Airrack — slug `airrack`
4. Mina Le — https://www.youtube.com/@gremlita — slug `mina-le`
...
**Lead output:** `working/waves/report-06.md` — per-worker status, anomalies, next actions. Lead final message ≤500 words.

...
1. mkbhd — Marques Brownlee — shortlist rank #8
2. linus-tech-tips — Linus Sebastian — shortlist rank #9
3. wendover-productions — Sam Denby — shortlist rank #10
4. tom-scott — Tom Scott — shortlist rank #11
...
**Lead output:** `working/waves/report-09.md` — per-worker status (done / fail / retried), verdicts, anomalies, next actions. Lead final message ≤500 words: status, file paths, verdicts, next actions. Never paste file contents.
